.. eWRT - Extensible Web Retrieval Toolkit documentation master file, created by
   sphinx-quickstart on Fri Mar 22 13:38:01 2013.
...
eWRT has been jointly developed by researchers from `MODUL University Vienna <http://www.modul.ac.at/nmt/>`_, `webLyzard
technology <http://www.weblyzard.com/>`_, the `University of Applied Sciences Chur
<http://weichselbraun.net/software.html>`_, and the `Vienna University of Economics and Business
<http://wu.ac.at/firm>`_. The library is currently being extended as part of the `uComp Project <http://www.ucomp.eu/>`_, which investigates Embedded Human Computation for Knowledge Extraction and Evaluation.

Checkout: eWRT on `gitweb <https://git.semanticlab.net/?p=eWRT.git;a=summary>`_.

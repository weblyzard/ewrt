...
class OntologyEvaluator(object):
    ...
    def __init__(self, rdf, root_node):
        ...
        self.nodes = {}
        # otherwise only nodes with a specified hierarchy link type will be
        # counted
        self.counterAllNodes = 0
        self._buildTree()
    ...
    def getSimilarity(self, correct_node, response_node):
        ...
        if correct_node == response_node:
            ...
            cp, msca = OntologyEvaluator.findMSCA(
                cn.pathsToRoot, rn.pathsToRoot)
            self.cp = cp
    ...
    def calcBDM(self, concept, response):
        ...
        bdm = (br * (cp / avgChainLength)) / (br * (cp / avgChainLength) +
                                              (dpk / conceptAvgLen) + (dpr / responseAvgLen))
...
# idea: create a class for the rdf-tree? and a class for the
# OntologyEvaluatorTools
...
class Node(object):
    ...
    def __getShortestPathLength(self):
        ...
        if len(self.shortestPath) == 0:
            self.shortestPath = self.getShortestPathToNode(
                self.evaluator.root_node)
...
class TestOntologyEvaluator(unittest.TestCase):
    ...
    def test_getPathToNode(self):
        ...
        paths = [
                [rdflib.URIRef('http://semanticweb.net/c4'), rdflib.URIRef(
                    'http://semanticweb.net/c2'), rdflib.URIRef('http://semanticweb.net/c1')],
        ...
        print('paths to node = ', node.getPathsToNode(
            'http://semanticweb.net/c3'))
    ...
    def test_findShortestPath(self):
        ...
        assert shortestPath == [rdflib.URIRef('http://semanticweb.net/c4'), rdflib.URIRef(
            'http://semanticweb.net/c2'), rdflib.URIRef('http://semanticweb.net/c1')]
        ...
        assert len(shortestPath) == 3
        assert shortestPath == [rdflib.URIRef('http://semanticweb.net/c4'), rdflib.URIRef(
            'http://semanticweb.net/c8'), rdflib.URIRef('http://semanticweb.net/c3')]
    ...
    def test_compareLists(self):
        ...
        array1 = [rdflib.URIRef('http://semanticweb.net/c7'), rdflib.URIRef(
            'http://semanticweb.net/c2'), rdflib.URIRef('http://semanticweb.net/c1')]
        array2 = [rdflib.URIRef('http://semanticweb.net/c4'), rdflib.URIRef(
            'http://semanticweb.net/c2'), rdflib.URIRef('http://semanticweb.net/c1')]
        print(OntologyEvaluator.compareLists(array1, array2))
        assert OntologyEvaluator.compareLists(array1, array2) == [rdflib.URIRef(
            'http://semanticweb.net/c1'), rdflib.URIRef('http://semanticweb.net/c2')]

        print('second test')
        path = []
        array1 = [rdflib.URIRef('http://semanticweb.net/c8'), rdflib.URIRef(
            'http://semanticweb.net/c3'), rdflib.URIRef('http://semanticweb.net/c1')]
        array2 = [rdflib.URIRef('http://semanticweb.net/c7'), rdflib.URIRef(
            'http://semanticweb.net/c3'), rdflib.URIRef('http://semanticweb.net/c1')]
        assert OntologyEvaluator.compareLists(array1, array2, []) == [rdflib.URIRef(
            'http://semanticweb.net/c1'), rdflib.URIRef('http://semanticweb.net/c3')]
    ...
    def test_findMSCA(self):
        ...
        cnode_paths = [
            ...
            [rdflib.URIRef('http://semanticweb.net/c4'), rdflib.URIRef('http://semanticweb.net/c8'), rdflib.URIRef('http://semanticweb.net/c3'), rdflib.URIRef('http://semanticweb.net/c1')]]
        rnode_paths = [
            [rdflib.URIRef('http://semanticweb.net/c7'), rdflib.URIRef(
                'http://semanticweb.net/c2'), rdflib.URIRef('http://semanticweb.net/c1')],
        ...
        print(len, path)
        assert len == 2
        assert path == rdflib.URIRef(
            'http://semanticweb.net/c3') or path == rdflib.URIRef('http://semanticweb.net/c2')
    ...
    def test_calcBR(self):
        ...
        assert 1.5 == self.oe.calcBR(
            self.oe.nodes[URIRef('http://semanticweb.net/c3')])
    ...
    def test_sample_of_paper(self):
        ...
        # ontology can be downloaded from
        # http://veggente.berlios.de/ns/RIMOntology
